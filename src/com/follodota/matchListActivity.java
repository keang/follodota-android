...
/**
 * An activity representing a list of matches. This activity has different
...
public class matchListActivity extends FragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.match_detail_container) != null) {
			...
			((matchListFragment) getSupportFragmentManager().findFragmentById(
					R.id.match_list)).setActivateOnItemClick(true);
		}
	...
	public void onMatchSelected(Match match) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.match_detail_container, fragment).commit();
